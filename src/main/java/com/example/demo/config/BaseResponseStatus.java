...
public enum BaseResponseStatus {
    ...
    POST_USERS_EXISTS_PHONE(false,2023,"중복된 핸드폰번호입니다."),
    POST_USERS_EXISTS_RESERVE(false,2022,"이미 등룩된 예약정보입니다."),
    ...
    MODIFY_FAIL_FIXPASSWORD(false,4018,"새 비밀번호가 일치하지 않았습니다"); // 내가만듬!
